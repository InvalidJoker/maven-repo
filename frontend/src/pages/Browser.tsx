                ...
                {data.entries.map((entry) =>
                  entry.directory ? (
                    <button
                      key={entry.name}
                      onClick={() =>
                        navigate(repoHref(repo, [...segs, entry.name]))
                      }
                      className="flex w-full items-center gap-2 border-b border-neutral-800 px-3 py-2 text-left text-sm last:border-b-0 hover:bg-neutral-900"
                    >
                    ...
                    <a
                      ...
                      className="flex items-center gap-2 border-b border-neutral-800 px-3 py-2 text-sm last:border-b-0 hover:bg-neutral-900"
                    >
                      <EntryIcon entry={entry} />
              ...
              {data.version ? (
                ...
                <Card className="p-4">
                  <div className="mb-3 flex items-center justify-between">
                    <PanelTitle>Install</PanelTitle>
                    <Badge tone="amber">
                      latest · {data.artifact.latestVersion}
                    </Badge>
                  </div>
                  <p className="mb-3 text-xs text-neutral-500">
                    ...
                    <div className="mt-2 flex flex-wrap gap-1.5">
                      {data.artifact.versions.map((v) => (
                        <button
                          ...
                          className="rounded border border-neutral-700 px-1.5 py-0.5 text-xs text-neutral-300 hover:border-brand-600 hover:text-brand-300"
                        >
                          {v}
                        </button>
                      ))}
